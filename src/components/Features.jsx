...
import { MessageCircle, Search, Users, Bot, Shield, Globe, BarChart3, Settings } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
            ...
            <span className="block text-blue-600">Enterprise AI</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-gray-50 p-8 rounded-xl hover:shadow-lg transition-all duration-200 hover:bg-white border border-transparent hover:border-gray-200">
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-center text-white">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-blue-100 mb-6">
              Join thousands of companies already using Adople to revolutionize their enterprise operations
            </p>
